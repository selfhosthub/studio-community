...
shown. The file name links to its Hugging Face repository. Files marked
gated need a Hugging Face account and the license terms accepted in the browser
before the download works, whatever the license says. Everything else is an
open download.
...
| [ae.safetensors](https://huggingface.co/black-forest-labs/FLUX.1-schnell) | vae/FLUX1 | 0.3 GB | gated | all Schnell |
